...
begin
	...
	select m.MealName,Calories =  sum( r.Calories)
	from meal m
	join Users u
...
--	select m.Mealid, m.MealName,  Users = concat(u.UserFirstName,' ', u.UserLastName), Calories =  sum( r.Calories)
--	from meal m
--	join Users u
--	on m.usersid = u.UsersId
--	join Recipe r
...
--select sum(r.calories), m.MealName
--from Meal m 
