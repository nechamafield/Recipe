...
--1) Sometimes when a staff member is fired. We need to eradicate everything from that users in our system. Write the SQL to delete a specific users and all the users's related records.
...
select u.usersFirstName, u.usersLastName,  
      EmailAddress = concat(SUBSTRING(u.usersFirstName,1,1), u.usersLastName, '@heartyhearth.com'),
